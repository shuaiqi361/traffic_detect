...
out_dict = '{}/mask_fromDTM_extreme_basis_m{}_n{}_a{:.2f}.npy'.format(save_data_root, mask_size, n_coeffs, alpha)
out_resampled_shape_file = '{}/train_mask_basis_extreme_fromDTM_m{}.npy'.format(save_data_root, mask_size)
...
for annotation in all_anns:
    ...
    # resized_dist_bbox = np.pad(resized_dist_bbox, 1, mode='constant')
    ...
    # recovered_mask = np.where(dist_bbox_in > 0, 255, 0).astype(np.uint8)
