...
out_dict = '{}/Basis_{}_DTMs_absolute_m{}_n{}_a{:.2f}.npy'.format(save_data_root, dist_type, mask_size, n_coeffs, alpha)
out_resampled_shape_file = '{}/train_mask_absolute_{}_DTM_m{}.npy'.format(save_data_root, dist_type, mask_size)
...
# shape_per_cat = 500
# max_dtm_values = []  # from training data, you will get 25.414, which is the mean max value
#
...
#     # max_dtm_values.append(np.max(dist_bbox_in))
#     dist_bbox_in = dist_bbox_in / 25.414
#
...
#
# # print('average max dtm:', np.mean(max_dtm_values))
# # exit()
#
