...
out_dict = '{}/mask_fromScipyDTM_minusone_basis_m{}_n{}_a{:.2f}.npy'.format(save_data_root, mask_size, n_coeffs, alpha)
out_resampled_shape_file = '{}/train_mask_basis_minusone_fromScipyDTM_m{}.npy'.format(save_data_root, mask_size)
...
for annotation in all_anns:
    ...
    cv2.imshow('weights', dtm_weights.astype(np.uint8))
