...
out_dict = '{}/Centered_complement_DTM_basis_m{}_n{}_a{:.2f}.npz'.format(save_data_root, mask_size, n_coeffs, alpha)
out_resampled_shape_file = '{}/train_complement_DTM_basis_fromDTM_m{}.npy'.format(save_data_root, mask_size)
...
for annotation in all_anns:
    ...
    # dtm_show = np.where(dist_bbox_in > 0, 1 - dist_bbox_in, 0) * 255
    ...
    dist_bbox = np.where(dist_bbox_in > 0, 1.5 - (dist_bbox_in + 1) / 2., -1.)  # in the range of -1, (0, 1]
