...
out_dict = '{}/mask_fromDTM_extended_basis_m{}_n{}_a{:.2f}.npy'.format(save_data_root, mask_size, n_coeffs, alpha)
out_resampled_shape_file = '{}/train_mask_basis_extended_fromDTM_m{}.npy'.format(save_data_root, mask_size)
...
for annotation in all_anns:
    ...
    if np.sum(resized_dist_bbox) < 5:  # for foreground object
